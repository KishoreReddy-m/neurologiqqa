...
import MainIcon from "src/assets/images/MainIcon.svg";
import React from "react";
import EmialVerify from "./VerifyPage";
  ...
  return (
    <Grid className="main-grid">
      ...
      >
        ...
        >
          <Tab label={<span className="tab-text">Token</span>} />
        </Tabs>
        <Divider variant="fullWidth" />
        <TabPanel value={value} index={0}>
          <Typography style={{ textAlign: "center" }}>
            Please enter your token below  send you a token
